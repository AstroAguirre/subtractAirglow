...
UiMainWindow,QtWidgets.QMainWindow=loadUiType('subtractAirglow/AirglowRemoval_v2.ui',from_imports=True,import_from='subtractAirglow')
UiStisWindow,QtWidgets.QMainWindow=loadUiType('subtractAirglow/AirglowRemoval_STIS_v2.ui',from_imports=True,import_from='subtractAirglow')
UiResidWindow,QtWidgets.QMainWindow=loadUiType('subtractAirglow/AirglowRemoval_Residuals_v2.ui',from_imports=True,import_from='subtractAirglow')
UiRangeWindow,QtWidgets.QDialog=loadUiType('subtractAirglow/AirglowRemoval_Range_v2.ui',from_imports=True,import_from='subtractAirglow')
UiFillWindow,QtWidgets.QDialog=loadUiType('subtractAirglow/AirglowRemoval_Missing_v2.ui',from_imports=True,import_from='subtractAirglow')
UiFillWindow2,QtWidgets.QDialog=loadUiType('subtractAirglow/AirglowRemoval_Missing2_v2.ui',from_imports=True,import_from='subtractAirglow')
UiTrueWindow,QtWidgets.QDialog=loadUiType('subtractAirglow/AirglowRemoval_Recovered_v2.ui',from_imports=True,import_from='subtractAirglow')
UiValsWindow,QtWidgets.QDialog=loadUiType('subtractAirglow/AirglowRemoval_Results_v2.ui',from_imports=True,import_from='subtractAirglow')
UiBootWindow,QtWidgets.QDialog=loadUiType('subtractAirglow/AirglowRemoval_Bootstrap_v2.ui',from_imports=True,import_from='subtractAirglow')
